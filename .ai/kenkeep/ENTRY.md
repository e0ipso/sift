...
- Load [`kenkeep/`](nodes/kenkeep/index.md) for more information on Kenkeep prompt ownership and knowledge lifecycle contracts; read before changing capture, curation, or admission rules.
