...
- Open [**Resolve the sift tree by walking up for the .ai/sift directory**](../sift-drain/tracker-runtime/practice-resolve-the-sift-tree-by-walking-up-for-the-ai-sift-directory.md) — Walk up from cwd for the .ai/sift directory, stop when parent equals cur, and absolutize SIFT_ROOT overrides.
### #skills
