...
`tests/scripts/sift-init-tree.test.sh`, and the `@SKILL-COPY:` inventory in AGENTS.md. None
...
withdrawn path. The consequence is that closing such a gap takes both edits in one commit:
